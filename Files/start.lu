...
type = 'inline',
data = {
{{text = ' ᥀︙ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙆𝙐𝙇𝙕',url="t.me/VV466"}},
}
}
...
{{text = ' ᥀︙ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "سكولز"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/VV455&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  ᥀︙الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "سكولز"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "سكولز"),"اني لقميل "..(redis:get(bot_id..":namebot") or "سكولز"),(redis:get(bot_id..":namebot") or "سكولز").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "سكولز") then
...
----------------------------------------------------------------------------------------------------
-- نهايه التفعيل
if text == 'السورس' or text == 'سورس' or text == 'سورس سكولز' or text == 'يا سورس' then 
local Text = "*Welcome to Source SKULZ\n\n*[ ᥀︙  SKULZ Channel](http://t.me/NNN8X)*\n\n*[ ᥀︙  INFO Source](http://t.me/VV466)*\n\n*[ ᥀︙  DaR Developer](http://t.me/Zbbbbb)*\n\n*[ ᥀︙  BoT DaR](http://t.me/OF4CBOT)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙆𝙐𝙇𝙕 ',url="t.me/VV466"}
